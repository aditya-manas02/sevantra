...
exports.getOrgProfile = exports.updateUserProfile = exports.getUserProfile = void 0;
...
const updateUserProfile = async (req, res) => {
    try {
        const userId = req.user?.id; // auth middleware sets req.user to the full user object
        if (!userId) {
